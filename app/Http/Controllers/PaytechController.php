...
class PaytechController extends Controller
{
    ...
    public function initiatePayment(Request $request)
    {
        ...
        $user = Auth::user();
        $formation = Commande::findOrFail($validatedData['formation_id']);
    ...
    public function handleNotification(Request $request)
    {
        ...
        $formation = Commande::find($formationId);
    ...
    private function isPaymentComplete($status)
{
    ...
    private function handleSuccessfulPayment($payment, $user, $formation)
    {
        ...
        try {
            ...
            // Vérifier si le paiement concerne une formation et changer le rôle en étudiant
            if ($formation) {
                $user->role = 'etudiant';
    ...
    public function paymentSuccess(Request $request)
    {
        ...
        try {
            $user = Auth::user();
            $formation = Commande::find($request->input('formation_id'));
